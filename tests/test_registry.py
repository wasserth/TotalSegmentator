...
class TestRegistry(unittest.TestCase):
    ...
    def test_known_examples(self):
        ...
        self.assertEqual(get_task_classes("total")[26], "vertebrae_L6")
        self.assertNotIn("vertebrae_S1", get_task_classes("total").values())
        ...
        self.assertTrue(requires_license("appendicular_bones_highres"))
        self.assertEqual(get_task_classes("appendicular_bones_highres"), get_task_classes("appendicular_bones"))
        self.assertEqual(task_modality("appendicular_bones_highres"), "CT")
        ...
        self.assertTrue(requires_license("pulmonary_artery_landmarks"))
        self.assertEqual(
            get_task_classes("pulmonary_artery_landmarks")[7], "pul_right_start"
        )
