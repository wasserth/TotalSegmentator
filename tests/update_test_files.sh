...
totalseg_get_phase -i tests/reference_files/example_ct_sm.nii.gz -o tests/reference_files/phase_prediction.json -d cpu
totalseg_get_body_stats -i tests/reference_files/example_ct_sm.nii.gz -m ct -o tests/reference_files/body_stats_prediction.json -d cpu
