...
def download_pretrained_weights(task_id):
    ...
    # CNN - MR
        ...
        weights_path = config_dir / "lightning_models" / "mr_size_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/mr_size_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"
    elif task_id == "body_stats_cnn_mr_age":
        weights_path = config_dir / "lightning_models" / "mr_age_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/mr_age_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"
    elif task_id == "body_stats_cnn_mr_sex":
        weights_path = config_dir / "lightning_models" / "mr_sex_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/mr_sex_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"

    # CNN - CT
    elif task_id == "body_stats_cnn_ct_weight":
        weights_path = config_dir / "lightning_models" / "ct_weight_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/ct_weight_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"
        # weights_url = url + "/v2.5.0-weights/ct_weight_splitOrig_2d_ns5_mo1_effnetv2.zip"
        # WEIGHTS_URL = "TODO"
    elif task_id == "body_stats_cnn_ct_size":
        weights_path = config_dir / "lightning_models" / "ct_size_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/ct_size_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"
    elif task_id == "body_stats_cnn_ct_age":
        weights_path = config_dir / "lightning_models" / "ct_age_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/ct_age_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"
    elif task_id == "body_stats_cnn_ct_sex":
        weights_path = config_dir / "lightning_models" / "ct_sex_splitXGB_2d_ns5_mo1_effnetv2_npy0"
        WEIGHTS_URL = url + "/v2.5.0-weights/ct_sex_splitXGB_2d_ns5_mo1_effnetv2_npy0.zip"
