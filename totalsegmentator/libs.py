...
def download_pretrained_weights(task_id):
    ...
    if task_id == 251:
        ...
        WEIGHTS_URL = url + "/v1.5.6-weights/Task251_TotalSegmentator_part1_organs_1139subj.zip"
    elif task_id == 252:
        config_dir = config_dir / "3d_fullres"
        ...
        WEIGHTS_URL = url + "/v1.5.6-weights/Task252_TotalSegmentator_part2_vertebrae_1139subj.zip"
    elif task_id == 253:
        config_dir = config_dir / "3d_fullres"
        ...
        WEIGHTS_URL = url + "/v1.5.6-weights/Task253_TotalSegmentator_part3_cardiac_1139subj.zip"
    elif task_id == 254:
        config_dir = config_dir / "3d_fullres"
        ...
        WEIGHTS_URL = url + "/v1.5.6-weights/Task254_TotalSegmentator_part4_muscles_1139subj.zip"
    elif task_id == 255:
        config_dir = config_dir / "3d_fullres"
        ...
        WEIGHTS_URL = url + "/v1.5.6-weights/Task255_TotalSegmentator_part5_ribs_1139subj.zip"
    elif task_id == 256:
        config_dir = config_dir / "3d_fullres"
